...
namespace Ez.XControls
{
    [ToolboxBitmap(typeof(XMaskLayer))]
    public class XMaskLayer:Control
    {
        private bool _transparentBG = true;
        private int _alpha = 125;
        private System.ComponentModel.Container components = new System.ComponentModel.Container();

        public XMaskLayer():this(125,true)
        {
 
        }
        public XMaskLayer(int Alpha, bool showLoadingImage)
        {
            ...
            if (showLoadingImage)
            {
                ...
                //pictureBox_Loading.BackColor = System.Drawing.Color.Red;
                //pictureBox_Loading.Image = global::Ez.XControls.Properties.Resources.loading;
        ...
        [Category("XMaskLayer"), Description("是否使用透明,默认为True")]
        ...
        [Category("XMaskLayer"), Description("设置透明度")]
        public int Alpha
        {
            get { return _alpha; }
            set
