...
namespace Ez.XControls.TextBoxs
{
    [ToolboxItem(true)]
    public class XTextBox : System.Windows.Forms.TextBox
    {
        ...
        /// 边框颜色 
        /// </summary> 
        private Color _BorderColor = Color.FromArgb(84, 159, 212);

        /// <summary> 
        /// 热点边框颜色 
        /// </summary> 
        private Color _HotColor = Color.FromArgb(0, 114, 198);
       ...
       DefaultValue(typeof(Color), "#549FD4")]
       ...
       /// <summary> 
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == 0xf || m.Msg == 0x133)
            {
                ...
                {
                    //边框Width为1个像素 
                    System.Drawing.Pen pen = new Pen(Utils.BorderColor, 1);
                    ...
                    if (this._HotTrack)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                pen.Color = Utils.HotColor;
                            }
                            else
                            {
                                pen.Color = Utils.BorderColor;
                            }
                        }
                    }
                    //绘制边框 
