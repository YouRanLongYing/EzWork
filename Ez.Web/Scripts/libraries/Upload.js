...
*/
$("body").append('<script src="/Scripts/plugins/uploadify/jquery.uploadify.min.js" type="text/javascript"></script>');
$("body").append('<link href="/Scripts/plugins/uploadify/uploadify.css" rel="stylesheet" type="text/css" />');
...
function uploadFile(btn, folder, allownum, type, success, auto, progressfn, btnclass, text, width, height) {
        ...
        var btnobj = (typeof (btn) == "string" ? $("#" + btn) : btn);
        btnobj.uploadify({
            'height': height||20,
            'width': width||80,
            'buttonClass': btnclass,
            'auto': auto,
            'swf': '/Scripts/plugins/uploadify/uploadify.swf?var=' + (new Date()).getTime(),
            'uploader': '/File/Uploads/',
            'buttonText': text||'浏览',
            'formData': { 'folder': folder },
            'cancelImg': '/Scripts/plugins/uploadify/uploadify-cancel.png',
