...
namespace Ez.UI.Validations
{
    ...
    public class PostCodeAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        {
            return ValidationHelper.IsPostCode((string)value);
        }
        /// <summary>
        /// 格式化错误信息
        /// </summary>
        ...
        {
            string erroemessage = EzLanguage.ResourceManager.GetString("SYS_Val_PostCode", System.Threading.Thread.CurrentThread.CurrentUICulture);
